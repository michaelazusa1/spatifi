...
between = (t, e, n) => {
    ...
    let e, n;
    if ("[" === t[0] ? (e = "[", n = "]") : "{" === t[0] && (e = "{", n = "}"), !e) throw new Error(`Can't cut unsupported JSON (need to begin with [ or { ) but got: ${t[0]}`);
    let r, o = !1,
        i = !1,
        s = 0;
    for (r = 0; r < t.length; r++)
        if ('"' !== t[r] || i) {
            if (i = "\\" === t[r] && !i, !o && (t[r] === e ? s++ : t[r] === n && s--, 0 === s)) return t.substr(0, r + 1)
        } else o = !o;
...
function getSearchJson(t) {
    return tojson(t.contents.twoColumnBrowseResultsRenderer.tabs[0].tabRenderer.content.sectionListRenderer.contents)
}
